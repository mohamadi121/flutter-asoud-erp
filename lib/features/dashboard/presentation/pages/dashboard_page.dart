      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            Text('دفتر فعال: ${AppConfig.companyName}',
      ...
      bottomNavigationBar: NavigationBar(
        ...
        destinations: const [
          ...
          NavigationDestination(
              icon: Icon(Icons.add_circle_outline_rounded), label: 'ثبت سریع'),
          NavigationDestination(
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
              colors: [AsoudColors.primary, AsoudColors.primaryDark]),
